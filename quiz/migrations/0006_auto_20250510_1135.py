# Generated by Django 2.2.7 on 2025-05-10 06:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='csvupload',
            name='file',
            field=models.FileField(upload_to=quiz.models.upload_csv_file, validators=[quiz.validators.csv_file_validator], verbose_name='Файл'),
        ),
        migrations.AlterField(
            model_name='csvupload',
            name='title',
        ...
        migrations.AlterField(
            model_name='quiz',
            name='answers_at_end',
            field=models.BooleanField(default=False, help_text='Правильные ответы не показываются сразу, а в конце', verbose_name='Показывать ответы в конце'),
        ),
        migrations.AlterField(
            model_name='quiz',
            name='category',
        ...
        migrations.AlterField(
            model_name='quiz',
            name='fail_text',
            field=models.TextField(blank=True, help_text='Отображается при неудаче', verbose_name='Текст при провале'),
        ),
        migrations.AlterField(
            model_name='quiz',
            name='max_questions',
            field=models.PositiveIntegerField(blank=True, help_text='Количество вопросов за один подход', null=True, verbose_name='Максимум вопросов'),
        ),
        migrations.AlterField(
            model_name='quiz',
            name='pass_mark',
        ...
        migrations.AlterField(
            model_name='quiz',
            name='success_text',
            field=models.TextField(blank=True, help_text='Отображается при успешном прохождении', verbose_name='Текст при успехе'),
        ),
        migrations.AlterField(
            model_name='quiz',
            name='title',
        ...
        migrations.AlterField(
            model_name='quiz',
            name='url',
            field=models.SlugField(help_text='Удобный URL', max_length=60, verbose_name='ЧПУ'),
        ),
        migrations.AlterField(
            model_name='sitting',
            name='complete',
